...
class LifePanel extends JPanel implements Runnable {
    ...
    private static final Color c0 = new Color(0x57AFD9);
    private static final Color c1 = new Color(0xFF7665);
                    ...
                    synchronized (life) {
                        ...
                        if (x >= 0 && y >= 0 && x < life.getWidth() && y < life.getHeight()) {
                            if (pressedLeft == true) {
                                ...
                                life.setDeField(x, y, (byte) 1);
                                repaint();
                            }
                            if (pressedRight == true) {
                                life.setCell(x, y, (byte) 0);
                                life.setDeField(x, y, (byte) 0);
                                repaint();
                            }
                        }
                    }
